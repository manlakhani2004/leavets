    ...
    <div className="flex flex-col lg:flex-row items-center min-h-screen px-4 bg-slate-900">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center flex-1 px-12">
        <h1 className="text-4xl font-extrabold text-indigo-400 mb-4 text-center leading-tight">
          Welcome Back to LeaveTracker
        </h1>

        <p className="text-lg text-white/70 mb-8 text-center max-w-sm">
          Smart, simple, and secure leave management for your team
        </p>

        <div className="mt-4 grid grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center text-white/70 hover:text-indigo-400 transition">
            <span className="text-4xl mb-2">📅</span>
            <span className="text-sm font-medium">Track leaves easily</span>
          </div>
          <div className="flex flex-col items-center text-center text-white/70 hover:text-indigo-400 transition">
            <span className="text-4xl mb-2">✅</span>
